// All code commented out due to disabled swimming system.
...
//                     // Use map directly (AtomicRef implements Deref)
//                     let water_neighbors: Vec<(f32, f32)> = (&*map)
//                         .neighbors(pos.x as i32, pos.y as i32)
//                         .into_iter()
//                         .filter(|&(wx, wy)| map.is_water(wx, wy))
